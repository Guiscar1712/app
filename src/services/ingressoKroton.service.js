...
module.exports = class IngressoKrotonService {
    static async getToken() {
        ...
        return (await axios.post(config.kroton.ingresso.url + "/oauth2/token", body, {
            headers: {
    ...
    static async getSubscription(cpf, token) {
        return (await axios.get('https://ingresso-api.kroton.com.br/ms/inscricaocqrs/captacao/v5/inscricao/cpf/' + cpf, {
            headers: {
                'Ocp-Apim-Subscription-Key': config.kroton.ingresso.OcpApimSubscriptionKey,
                'Authorization': token
            }
        })).data;
    }
    ...
    static async createSubscription(body, token) {
        return (await axios.post('https://ingresso-api.kroton.com.br/ms/inscricaocqrs/captacao/v5/inscricao',
            body, {
            headers: {
                'Ocp-Apim-Subscription-Key': config.kroton.ingresso.OcpApimSubscriptionKey,
                'Authorization': token
