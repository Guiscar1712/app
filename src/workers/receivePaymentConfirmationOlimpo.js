...
const workerLog = 'Worker Receive Servicebus OLIMPO'

const connectionString = process.env.COGNA_OLIMPO_PAYMENT_CONNECTION_STRING
const topicName = process.env.COGNA_OLIMPO_PAYMENT_TOPIC
const subscriptionName = process.env.COGNA_OLIMPO_PAYMENT_SUBSCRIPTION
